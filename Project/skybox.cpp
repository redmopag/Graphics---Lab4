...
void SkyBox::Render()
{
    // начинаем с разрешени€ метода скайбокса
    m_pSkyboxTechnique->Enable();

    // функци€ возвращает значение состо€ни€ OpenGL дл€ перечислени€, указанного в первом параметре.
    // ¬торой параметр - это адрес на массив типа int, который получит состо€ние
