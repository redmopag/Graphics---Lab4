...
// ¬ершинный шейдер
// преобразуем вход€щий вектор позиции как обычно через матрицу WVP, но затем в векторе,
// который будет передан в фрагментный шейдер, мы замен€ем координату Z на W
// используем исходные позиции в локальном пространстве как 3D координаты текстуры
